...
class Candidate {
  ...
  //optional parameter:: {name = "keshvi", department}
  //input parameter and optional parameter name not are same i.e. _name / name both are different

  //sequence parameter:: must be dynamic datatype
  // not used to nullable (bank operator?)
  // not used private variable (_name)
